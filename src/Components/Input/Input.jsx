...
function Input({ label,
  ...
  return (
    <div className='w-full flex relative flex-col gap-3'>
      ...
      <input type={type} className={`p-2 sm:p-3 rounded-lg bg-transparent placeholder:text-red-500 text-red-600 outline-none focus:border-red-600  duration-200 border border-red-700 w-full ${className}`}
        ref={ref} id={id}
        {...props} />
