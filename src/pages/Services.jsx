...
function Services() {
  ...
  const services = [
    {
      serviceImage: "Digital-marketing.svg",
    ...
    {
      serviceImage: "Print-digital-magazine.svg",
    ...
    {
      serviceImage: "Website-development.svg",
    ...
    {
      serviceImage: "Email-marketing.svg",
    ...
    {
      serviceImage: "Graphics-Designing.svg",
    ...
    {
      serviceImage: "Content-writing.svg",
    ...
    {
      serviceImage: "B2B-lead-generation.svg",
  ...
  return (
    ...
    <>
      <section className=" mt-[15vh] sm:mt-[19vh] p-5">
